...
var Index = React.createClass({
    ...
    render: function () {
        var tabBd,
            tabArr = [<IndexTabBdL sorce="/weixin/info/getAdvertList" data={this.state.activeData}/>,
                <IndexTabBdR data={this.state.gategoryData}/>];
...
var IndexTabBdR = React.createClass({
    render: function () {
        var gategoryImg = '';
        var BdRStr = this.props.data.map(function (m, i) {
            return (
                <li key={m.cateId}>
                    <a href="/m/html/gategory-list.html?cateid={m.cateId}&catename={m.cateName}" className="bg">
                        <img src={require('../../img/ui/gategory/'+(i+1)+'.png')}/>
                    </a>
        ...
        return (
            <div className="bottom-btn-warp" ref="ccq">
                <div className="bbtn-c">
                    ...
                    <div className="btn-scrolltop" onClick={this.scrollTop} ref="btnScrolltop"
