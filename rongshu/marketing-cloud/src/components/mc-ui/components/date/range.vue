/*
 * @Author: AnThen
 * @Date: 2017-08-17 11:53:04
 * @Last Modified by: AnThen
 * @Last Modified time: 2017-08-31 14:18:10
 */
<style lang="scss" scoped>
@import '~vars';
@import '~mixin';
.mc-dateRange-box{position: absolute; width: 340px; height: 436px; z-index: 100; border: 2px solid $black; background-color: rgba($black,0.8);
  ::-webkit-scrollbar {
    width: 0;
  }
  ...
  .cont-box{float: left; width: 100%; height: 286px; padding: 20px 0;
    ...
    .cont-container{position: relative; float: left; width: 100%; height: 226px;
      ...
      .container{position: absolute; width: 100%; top: 50px; bottom: 0; overflow-x: hidden; overflow-y: auto;
        ...
        .monthList{width: 100%;
          .month-box{float: left; width: 25%; height: 62px; overflow: hidden; margin: 5px 0; @include flex-display; @include flex-center;
        ...
        .dayList{width: 100%;
          .day-box{float: left; width: 14.28%; height: 34px; overflow: hidden; margin-bottom: 1px; @include flex-display; @include flex-center;
            .day{width: 46px; height: 34px; @include flex-display; @include flex-center; font-size: 14px;}
  ...
  <div class="mc-dateRange-box" v-if="dateBox" :style="{top: dateBoxClass.top+'px', left: dateBoxClass.left+'px'}">
    <div class="step-box">
      ...
      <div class="item-box">
        ...
        <div class="day" :class="itemBox.day60"
        @click="itemBoxChoice('day60',itemBox.day60)">
          <div class="title">60天</div>
          <div class="dian-box">
            <div class="dian"></div>
          </div>
        </div>
...
export default {
  ...
  methods: {
    openDate (val) {
      ...
      initItemBoxStart = dateParamStartArray[0]+'-'+dateParamStartArray[1]+'-'+dateParamStartArray[2]
    ...
    initItemBox (start,end) {
      ...
      if (this.dateInput) {
        ...
        switch (interval) {
          ...
          case day60Interval:
          this.itemBox.day60 = 'hover'
          longAgo = util.longLongAgo(end,day60Interval)
          break
          case day90Interval:
          this.itemBox.day90 = 'hover'
    ...
    itemBoxChoice (obj,val) {
      ...
      if (val == '') {
        ...
        switch (obj) {
          ...
          case 'day60':
          this.itemBox.day60='hover'
          dateStart = util.longLongAgo(leastDate,day60Interval)
          this.dayRegion(dateStart,leastDate)
          break
          case 'day90':
          this.itemBox.day90='hover'
    ...
    itemBoxChange (start,end) {
      ...
      if ((this.itemBox.day60).indexOf('hover') > -1) {
        this.itemBox.day60 = (this.itemBox.day60).replace(new RegExp('hover'), "")
      }
      ...
      if (interval>=day30Interval) {this.itemBox.day30 = ''}
      if (interval>=day60Interval) {this.itemBox.day60 = ''}
      if (interval>=89) {this.itemBox.day90 = ''}
      switch (interval) {
        case day30Interval:
        this.itemBox.day30 = 'hover'
        longAgo = util.longLongAgo(end,day30Interval)
