...
module.exports = {
  'app': {
    ...
    'grafana': {
      'host': 'http://grafana.in.dataengine.com',
      'fullScreenUrl': '/dashboard/db/apm-dashboard?orgId=2&from=now%2FM&to=now%2FM',
      'login': '/login?sso=true'
    },
    'staticSrc': './dist/src',
    'renderView': './views',
    'serviceDirectory': './admin/services',
    'routeDirectory': './admin/routes',
    'outAuthRoutes': [
      '/',
      '/index'
    ],
  ...
  'runtime': {
    ...
    'i18n': {
      'locales': ['en-US', 'zh-CN'],
      'defaultLocale': 'zh-CN',
      'directory': './admin/runtime/locales',
      'updateFiles': false,
      'autoReload': true,
      'cookie': 'lang',
      'queryParameter': 'lang',
