define("arale/detector/1.1.0/detector-debug", [], function(require, exports, module) {
    var detector = {};
   ...
   */
    ...
    [ "tw", function(ua) {
        ...
        if (external) {
            //try {
                return external.twGetRunPath&&external.twGetRunPath.toLowerCase().indexOf("theworld") !== -1;
            //} catch (e) {}
        }
        return "theworld";
    ...
    [ "ie", re_msie ], [ "chrome", / (?:chrome|crios|crmo)\/([0-9.]+)/ ], // Android 默认浏览器。该规则需要在 safari 之前。
    [ "android", function(ua) {
        if (ua.indexOf("android") === -1) {
            return;
        }
        return /\bversion\/([0-9.]+(?: beta)?)/;
    } ], [ "safari", /\bversion\/([0-9.]+(?: beta)?)(?: mobile(?:\/[a-z0-9]+)?)? safari\// ], [ "firefox", /\bfirefox\/([0-9.ab]+)/ ], [ "opera", /\bopera.+version\/([0-9.ab]+)/ ], [ "uc", function(ua) {
