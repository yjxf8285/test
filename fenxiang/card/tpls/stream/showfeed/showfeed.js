...
define(function (require, exports, module) {
    ...
    exports.init = function () {
        ...
        var createFeed = function () { //创建一个feed
                        ...
                        if (responseData.success) {
                            ...
                            feedV = new FeedItemV({
                                ...
                                "deleteCb": function (responseData) {
                                    ...
                                    if (responseData.success) {
                                        if (feedType == 2003) { //如果是群通知
                                            tpl.navRouter.navigate('app/workmessage', {
                                                trigger: true
                                            });
                                        } else if (feedType != 4) {
                            ...
                            util.alert(responseData.message, function () {
                                tpl.navRouter.navigate('#stream', {trigger: true}); //返回到首页
                            });
                        }
                    }
                }, {
            ...
            //隐藏demo提醒
            var demoTip = Widget.query('.fs-demo-tip-dialog');
            demoTip && demoTip.hide();
            //隐藏左边栏和右边栏
            ...
            //隐藏qq客服和企信
            $('.right-apv-wrapper,.right-qq-apv').remove();
