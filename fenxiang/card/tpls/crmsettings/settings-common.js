...
define(function (require, exports, module) {
    ...
    exports.init = function (tplEl, tplName) {
        ...
        //注册子导航
     /*   util.tplRouterReg("#crmsettings/personalsetting");
        util.tplRouterReg("#crmsettings/resetpassword");
        util.tplRouterReg("#crmsettings/avatarsetting");
        util.tplRouterReg("#crmsettings/bindphone");
        util.tplRouterReg("#crmsettings/setupnodisturb");
        util.tplRouterReg("#crmsettings/personalclientconfig");
        util.tplRouterReg("#crmsettings/planremindconfig");
        util.tplRouterReg("#crmsettings/boundexmail");*/
        //初始化公海导航组件
    ...
    //刷新公海列表
    exports.refreshHighSeas = function(){
        if(!exports.highSeasWidget){
            return;
        }
        exports.highSeasWidget.refresh();
    };

    exports.highSeasWidget = null;
    ...
    exports.createCrmSettingLeftNav = function (tplEl, tplName) {
        ...
        //绑定公海客户点击事件
        tplLeftEl.on('click', '.nav-highseas', function (evt) {
            $('.ul-list', tplLeftEl).hide();
            if(exports.highSeasWidget == null){
                exports.highSeasWidget = new HighSeas({
                    "api":"/HighSeas/GetAllHighSeas"
                });
                exports.highSeasWidget.on("list",function(id,text){
                    exports.trigger("list",id,text);
                });
            } else {
            	exports.highSeasWidget.refresh();
            }
            ...
            tagListEl.hide();
            exports.highSeasWidget.show(evt);
            evt.preventDefault();
            evt.stopPropagation();
        });
        //绑定标签管理点击事件
        ...
        //自定义字段
        tplLeftEl.on('click', '.user-define-field-l', function (evt) {
            $('.ul-list', tplLeftEl).hide();
            if(exports.highSeasWidget){
                exports.highSeasWidget.hide();
            }
            var tagListEl = $('.user-define-field-list', tplLeftEl);
            tagListEl.show();
            evt.preventDefault();
            evt.stopPropagation();
        });
        util.regGlobalClick($('.label-manage-list', tplLeftEl));
        util.regGlobalClick($('.user-define-field-list', tplLeftEl));
        //注册高亮导航
        util.regTplNav($('.tpl-nav-l', tplLeftEl), 'state-active');
        util.regTplNav($('.user-define-field-list a', tplLeftEl), 'state-active');
                    ...
                    "success": function (responseData) {
                        if (responseData.success) {
                            ...
                            _.each(salesStages, function (salesStage) {
                                ...
                                trStr += '<tr data-salesstageno="' + salesStageNo + '"> <td><div class="mn-checkbox-box checkbox-for-comtable ' + mnDisabled + '">&nbsp;&nbsp;<span class="mn-checkbox-item js-inuse ' + mnSelected + '" data-value="' + inUse + '"></span> </div></td> <td><input type="text" class="crm-textfield input-name" value="' + name + '" ' + inputDisabled + '></td> <td><input type="text" class="crm-textfield input-winrate" value="' + winRate + '" ' + inputDisabled + '></td> </tr>';
                            });
                            tabodyEl.html(trStr);
                            that.show();//拼好了再显示
                        }
