...
define(function (require, exports, module) {
    ...
    var Businesstags = require('modules/crm-userdefinefield/crm-userdefinefield'),
        tplCommon = require('../settings-common');

    var tplName, businesstags;
    exports.init = function () {
        var tplEl = exports.tplEl;
        tplName = exports.tplName;
        var queryParams = util.getTplQueryParams();
        var tagType = queryParams ? queryParams.tagtype : 1;
        var businesstagsWarpEl = $('.userdefinefield-warp', tplEl);
        businesstags = new Businesstags({
