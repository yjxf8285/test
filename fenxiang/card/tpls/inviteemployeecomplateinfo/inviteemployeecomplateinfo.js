...
define(function(require, exports, module) {
    ...
    exports.init=function(){
		...
		var getRequestData=function(){
            var requestData={};
            var nickName= _.str.trim(nickNameEl.val());
            ...
            requestData["name"]= nickName?nickName:requestData["fullName"];    //如果昵称为空，默认采用fullName
				...
				util.api({
					...
					"success":function(responseData){
						...
						if(responseData.success){
                            ...
                            if(dataRoot.value1==-1){    //如果昵称重复，让用户手动输入昵称
                                nickNameEl.closest('dl').show();
                                nickNameEl.addClass('settings-input-onerror');
