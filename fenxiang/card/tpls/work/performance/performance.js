            ...
            bindEvents: function() {
                ...
                elEl.on('click', '.date-shortcut', function(evt) {
                    ...
                    if (meEl.hasClass('current-week')) { //本周
                        starttimeDs.setValue(weekRef.clone().startOf('week').add('d', 1));
                        endtimeDs.setValue(weekRef.clone().endOf('week').add('d', 1));
                    }
                    if (meEl.hasClass('last-week')) { //上周
                        starttimeDs.setValue(weekRef.clone().startOf('week').subtract('w', 1).add('d', 1));
                        endtimeDs.setValue(weekRef.clone().startOf('week'));
                    }
                    ...
                    if (meEl.hasClass('last-month')) { //上月
                        ...
                        endtimeDs.setValue(moment().startOf('month').subtract('d', 1));
                    }
                    evt.preventDefault();
                });
