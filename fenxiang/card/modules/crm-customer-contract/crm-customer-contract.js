...
define(function (require, exports, module) {
    var root = window,
        ...
        store = tpl.store,
        list = tpl.list;
    var htmltpl = require('modules/crm-customer-contract/crm-customer-contract.html');
    ...
    var CustomerBasic = Backbone.View.extend({
        tagName: 'div', //HTML标签名
        className: 'customer-contract-module', //CLASS名
        template: _.template($(htmltpl).filter('.crm-customer-contract-template').html()), //模板
        options: {
            warpEl: null,
            customerData: null
        },
