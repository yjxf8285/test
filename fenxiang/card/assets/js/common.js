...
(function (root) {
    ...
    var appStore = {};
    var fsPath=(publishModel=="product"?"card-dist":"card");
    //设置页面title
    FS.pageTitle="纷享销客 移动销售管理专家";
    //设置全局路径
    //FS.BASE_PATH='http://push.oa.b.qq.com/QQ00000011';
    FS.BASE_PATH = FS_BASEPATH||'';
    //版本号
    FS.version=fsVersion.join('.');
    _.extend(FS, {
    ...
    //seajs配置
    seajs.config({
        plugins: publishModel=="product"?[]:['shim', 'text', 'style'],
        // 别名配置
        alias: {
            '$': {
            ...
            'datatable_core': {
                "src": "assets/datatable/js/jquery.dataTables.js",
                "exports": function () {
                    return jQuery.fn.dataTable;
                }
            },
            'ztree_core': {
                "src": "assets/ztree/js/jquery.ztree.core-3.5.js",
                "exports": function () {
                    return jQuery.fn.zTree;
                }
            },
            'zclip_core': {
                "src": "assets/zclip/1.1.1/zclip_core.js",
                "exports": function () {
                    return jQuery.fn.zclip;
                }            
            },
            'audioplayer': {
            ...
            'highchartsTheme':"assets/js/highcharts.theme.js",
            'searchbox': "assets/uilibs/search-box.js",
            ...
            'cardcalendar': 'uilibs/card-calendar',
