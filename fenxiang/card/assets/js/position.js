...
define(function(require, exports, module) {
    ...
    var PositionCore=require('position_core');
    ...
    PositionCore.pin = function(pinObject, baseObject) {
        ...
        // 定位目标元素
        if(!(isPinFixed&&baseObject.element._id === 'VIEWPORT')){   //Fixed:对于相对于window做fixed定位的元素是不做处理的
    ...
    PositionCore.pinWithAnimate=function(pinObject, baseObject,opts){
        ...
        // 定位目标元素
        if(!(isPinFixed&&baseObject.element._id === 'VIEWPORT')){   //Fixed:对于相对于window做fixed定位的元素是不做处理的
            pinElement.stop(true,true).animate({ left: left, top: top },opts);
        }
    };
