...
define(function(require, exports, module) {
    ...
    var Select=SelectCore.extend({
        ...
        removeOption: function(option) {
            var result=Select.superclass.removeOption.apply(this,arguments);
            var removedIndex = getOptionIndex(option, this.options);
            var model = this.model.select;
            model.splice(removedIndex,1);   //删除对应位置option
            return result;
        },
        addOption: function(option){
            Select.superclass.removeOption.apply(this, ['[data-value=temp]']);    //删除临时列
            Select.superclass.addOption.apply(this,arguments);
        },
        render: function() {
