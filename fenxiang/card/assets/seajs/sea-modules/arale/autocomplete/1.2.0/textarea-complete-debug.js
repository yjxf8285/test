define("arale/autocomplete/1.2.0/textarea-complete-debug", [ "$-debug", "lepture/selection/0.9.0/selection-debug", "./autocomplete-debug", "arale/overlay/1.0.1/overlay-debug", "arale/position/1.0.0/position-debug", "arale/iframe-shim/1.0.1/iframe-shim-debug", "arale/widget/1.0.3/widget-debug", "arale/base/1.0.1/base-debug", "arale/class/1.0.0/class-debug", "arale/events/1.0.0/events-debug", "arale/widget/1.0.3/templatable-debug", "gallery/handlebars/1.0.0/handlebars-debug", "./data-source-debug", "./filter-debug", "./autocomplete-debug.tpl" ], function(require, exports, module) {
    var $ = require("$-debug");
