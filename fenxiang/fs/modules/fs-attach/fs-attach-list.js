            ...
            parse: function(responseData) {
                ...
                if(responseData.success){
                    ...
                    _.each(items, function(item,i) {
                        ...
                        if(attachs.length > 1){
                            imgSummary='<span class="employee-name">'+nickName+'</span>上传于'+util.getDateSummaryDesc(moment.unix(item.createTime),moment.unix(responseData.serviceTime),1)+'，图集（共'+attachs.length+'张）';
