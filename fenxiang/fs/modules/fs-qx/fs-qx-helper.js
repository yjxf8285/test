...
define(function(require, exports, module) {
    var root=window,
        FS=root.FS,
        tpl=FS.tpl;
    var moduleStyle=require('./fs-qx.css'),
    ...
    var JoinDialog=Dialog.extend({
        ...
        _renderList:function(){
            ...
            this.unjoinList.on('select',function(){
                ...
                if(selectedDatas.length==that.unjoinList.getData().length){
            ...
            this.joinList.on('select',function(){
                ...
                if(selectedDatas.length==that.joinList.getData().length){
        ...
        _clickMoveLeft:function(evt){
            ...
            if(joinMinNum>-1&&(joinDatas.length-joinSelectedDatas.length)<joinMinNum){
                //util.alert('讨论组最少应有'+joinMinNum+'人');
