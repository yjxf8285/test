    ...
    (function (factory) {
        ...
        Controller = (function () {
            ...
            Controller.prototype.catch_query = function () {
                ...
                caret_pos = FS.util.getCursorPosition(this.$inputor.get(0)).start;  //fuck ie6/7/8,获取cursor位置修正采用util.getCursorPosition
                /* 向在插入符前的的文本进行正则匹配
                ...
                */
                ...
                $.each(this.settings, function (flag, settings) {
                    _this.current_flag = flag;  //先尝试设置当前前置符
                ...
                if (typeof query === "string") {    //不限制请求字数
            ...
            Controller.prototype.replace_str = function (str) {
                var insertSeparator=this.get_opt("insertSeparator", true),
                    separator="";
                ...
                text = "" + start_str + str + separator + (source.slice(this.query['end_pos'] || 0));
                $inputor.val(text);
