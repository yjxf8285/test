...
define(function(require, exports, module) {
    ...
    var Preview = Overlay.extend({
        ...
        _createImgEl:function(){
            ...
            boxEl.html('<div class="ui-preview-img-wrapper"><img src="'+FS.BLANK_IMG+'" alt="loading" class="ui-preview-img" /></div><div class="ui-preview-img-tools"><span class="rotate-l">&#8630;向左旋转</span>&nbsp;&nbsp;&nbsp;<span class="rotate-r">&#8631;向右旋转</span>&nbsp;&nbsp;&nbsp;<a class="view-origin" href="#" target="_blank">查看原图</a>&nbsp;&nbsp;&nbsp;<a class="download-origin" href="#" target="_blank">下载原图</a>&nbsp;&nbsp;&nbsp;<a class="batch-download-origin" href="'+FS.API_PATH+'/df/GetBatchFiles?ids='+fileIds+'&names='+fileNames+'" target="_blank">打包下载</a></div>');
        ...
        _createNavEl:function(){
            ...
            var elEl=this.element,
                ...
                indicatorEl=$('<div class="ui-preview-nav-indicator"></div>'),  //导航指示器
        ...
        _setInfoHeight:function(){
            ...
            infoEl.height(elEl.height()-80);    //80px是margin
        },
         ...
         * @private
         */
        _getFileLink:function(){
            var type=this.get('type');
            return util.getDfLink.apply(this,arguments);
        },
