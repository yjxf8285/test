...
define(function(require, exports, module) {
    ...
    var util=require('util'),
        ...
        leftTpl=require('./shortmessage-common.html'),
        leftTplEl=$(leftTpl);
    //注册子路由
    util.tplRouterReg('#shortmessage/showsession/=/:id-:value/:empid-:value');
    exports.init=function(tplEl,tplName){
        ...
        var renderData={};
        var leftCompiled=_.template(leftTplEl.filter('.sm-tpl-left').html()); //模板编译方法
        _.extend(renderData,{
