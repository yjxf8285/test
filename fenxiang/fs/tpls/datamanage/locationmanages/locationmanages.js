        ...
        $.extend(Locationmanages.prototype, {
            ...
            bindEvents: function() {
                ...
                elEl.on('click', '.locationmanages-downbtn', function(evt) {
                    ...
                    util.confirm('是否要保存 定位统计报表', '提示', function(evt) {
...
//                    "url": '/Management/GetLocationResultExcel',
                    ...
                    "success": function(responseData) {
                        if (responseData.success) {
                            downbtnEl.attr('href', FS.API_PATH+'/df/gettemp?id='+responseData.value+'&name=定位统计报表.xls').removeClass('loading').html('生成完毕，点击下载报表');
                        } else {
                            downbtnEl.hide();
                        }
                    }
