...
define(function(require, exports, module) {
    ...
    exports.init = function() {
         ...
         * @param {object} opts
         */
        var Feedworkmanages = function(opts) {
            opts = $.extend({
        ...
        $.extend(Feedworkmanages.prototype, {
            /**
             * 初始化
             */
            init: function() {
            ...
            bindEvents: function() {
                ...
                //下载表格
                elEl.on('click','.feedworkmanages-downbtn', function(evt) {
            ...
            getMonthFeedPlanExcel: function() {
                var elEl = this.element;
                var downbtnEl = $('.feedworkmanages-downbtn', elEl);
                var selcetyearEl = $('.feedworkmanages-top-selcetyear', elEl);
                var selcetmonthEl = $('.feedworkmanages-top-selcetmonth', elEl);
                var circleIDs = '';
                var employeeIDs = '';
                ...
                util.api({
                        "url": '/Management/GetMonthFeedWorkExcel',
                    "type": 'get',
                    "dataType": 'json',
                    "data": {
                    ...
                    "success": function(responseData) {
                        if (responseData.success) {
                            downbtnEl.attr('href', FS.API_PATH+'/managementdf/gettemp?id='+responseData.value+'&name=员工月度日志统计报表.xls').removeClass('loading').html('生成完毕，点击下载报表');
                        } else {
                            downbtnEl.hide();
                        }
                    }
