...
define(function (require, exports, module) {
    ...
    exports.init=function(){
        ...
        var tplLeftEl=$('.tpl-l',tplEl),
            listEl=$('.audio-list',tplEl),
            pagEl=$('.audio-list-pagination',tplEl),
        ...
        var attachList=new AttachList({
            ...
            "listPath":"/FeedSearch/GetAudioFeedForSearch", //搜索附件地址
        ...
        /*tpl.event.on('switched', function (tplName2, tplEl) {
            if (tplName2 == tplName) {
                ...
                //高亮附件栏
                $('.tpl-nav-l',tplLeftEl).eq(3).addClass('depw-menu-aon');
                //首次触发查询全部发出的feed
